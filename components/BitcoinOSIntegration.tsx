...
import { TopMenuBar, DevSidebar, Dock, ProofOfConceptBar, BitcoinOSProvider } from '@bitcoin-os/bridge'
...
export default function BitcoinOSIntegration({ children }: BitcoinOSIntegrationProps) {
  ...
  return (
    <BitcoinOSProvider context={appContext}>
